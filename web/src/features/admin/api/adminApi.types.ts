...
export interface AdminStudentListItem { id: EntityId; platform: AdminPlatformContext; displayName: string | null; emailMasked: MaskedEmail | null; phoneMasked?: MaskedPhone | null; academicTermOrYear?: string | null; university?: string | null; academicInstitution?: string | null; academicLevel?: string | null; academicLevelId?: EntityId | null; academicSemester?: string | null; program?: string | null; expectedGraduationDate?: ISODate | null; studentIdMasked?: string | null; status: AdminStudentStatus; activeSubscriptionCount: number | null; activeGrantCount: number | null; activeDeviceCount: number | null; activeSessionCount: number | null; lastSeenAt?: ISODateTime | null; riskFlags: readonly AdminStudentRiskFlag[]; }
