...
export type M2InstructorStatus = "active" | "inactive";
export type M2BrandCourseScope = "curriculum" | "standalone";
export type M2BrandCourseStatus = "draft" | "published" | "archived";

export interface CreateInstructorCommand { readonly metadata: AdminSensitiveCommandMetadata; readonly displayName: string; readonly professionalTitle?: string | null; }
export interface UpdateInstructorCommand { readonly metadata: AdminSensitiveCommandMetadata; readonly instructorId: EntityId; readonly displayName?: string; readonly professionalTitle?: string | null; }
...
export interface SetBrandInstructorStatusCommand { readonly metadata: AdminSensitiveCommandMetadata; readonly brandId: EntityId; readonly instructorId: EntityId; readonly status: M2InstructorStatus; }
...
export interface SetCourseInstructorStatusCommand { readonly metadata: AdminSensitiveCommandMetadata; readonly brandId: EntityId; readonly courseId: EntityId; readonly instructorId: EntityId; readonly status: M2InstructorStatus; }
