...
export interface CreateBrandCourseCommand { readonly metadata: AdminSensitiveCommandMetadata; readonly brandId: EntityId; readonly academicInstitutionId: EntityId; readonly courseCode: string; readonly title: string; readonly courseScope: M2BrandCourseScope; readonly academicModuleId: EntityId | null; readonly cataloguePresentation?: M2BrandCourseCataloguePresentation; readonly status: "draft"; }
export interface UpdateBrandCourseCommand { readonly metadata: AdminSensitiveCommandMetadata; readonly brandId: EntityId; readonly courseId: EntityId; readonly academicInstitutionId?: EntityId; readonly title?: string; readonly courseScope?: M2BrandCourseScope; readonly academicModuleId?: EntityId | null; readonly cataloguePresentation?: M2BrandCourseCataloguePresentation; }
