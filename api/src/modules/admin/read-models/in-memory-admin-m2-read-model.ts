...
import type { AdminM2ReadModel, AcademicLevelAdminDto, AcademicSemesterAdminDto, AcademicModuleAdminDto, InstructorAdminDto, InstructorBrandAssignmentAdminDto, BrandCourseAdminDto, CourseInstructorAssignmentAdminDto } from "./admin-m2-read-model";
