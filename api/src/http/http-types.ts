...
export interface HttpAppDependencies { readonly admin: AdminModule; readonly adminHttpContextResolver?: AdminHttpRequestContextResolver; readonly config?: HttpRuntimeConfig; }
