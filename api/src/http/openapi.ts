...
export const openApiDocument = {
  ...
  paths: {
    ...
    "/ready": { get: { tags: ["System"], operationId: "getReady", summary: "Readiness probe", security: [], description: "Public readiness endpoint. It never requires Authorization or Idempotency-Key.", responses: { "200": response("Service is ready") } } },
    ...
    "/v1/ready": { get: { tags: ["System"], operationId: "getReadyV1Compatibility", summary: "Readiness probe (compatibility path)", deprecated: true, security: [], description: "Compatibility alias for /ready used by generic API test runners. Public; never requires Authorization or Idempotency-Key.", responses: { "200": response("Service is ready") } } },
    ...
    "/v1/admin/curriculum/levels": { get: { tags: ["Academic catalogue"], operationId: "listAcademicLevels", ...read("List academic levels") } },
    "/v1/admin/curriculum/semesters": { get: { tags: ["Academic catalogue"], operationId: "listAcademicSemesters", parameters: [{ name: "levelId", in: "query", required: false, schema: { type: "string", format: "uuid" } }], ...read("List semesters; optionally filter by academic level") } },
    ...
    "/v1/admin/instructors": {
      get: { tags: ["Instructors"], operationId: "listGlobalInstructors", ...read("List global instructor identities") },
    ...
    "/v1/admin/brands/{brandId}/courses": {
      get: { tags: ["Brand teaching"], operationId: "listBrandCourses", parameters: [id("brandId")], ...read("List courses owned by one brand"), responses:{...read("").responses,"200":catalogueReadResponse("CatalogueBrandCourse")} },
